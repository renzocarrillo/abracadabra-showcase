-- Fix: Corregir error de case-sensitivity en columnas de variants
-- El error era que nombreProducto y variante no usaban comillas dobles
-- PostgreSQL convierte a minúsculas sin comillas, pero las columnas tienen mayúsculas
...
BEGIN
  ...
  -- 3. Obtener stock y producto - FIX: usar comillas dobles para columnas con mayúsculas
  SELECT 
    s.id as stock_id, 
    s.disponibles,
    v."nombreProducto",
...
COMMENT ON FUNCTION scan_product_unified IS 'RPC unificado que valida, verifica stock y escanea producto en una sola operación atómica. Fix: usa comillas dobles para columnas con mayúsculas.';