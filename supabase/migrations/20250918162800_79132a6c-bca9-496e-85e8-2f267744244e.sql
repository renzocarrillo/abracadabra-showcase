-- First, fix all negative committed stock manually
UPDATE stockxbin 
SET 
...
-- Fix any negative disponibles as well
UPDATE stockxbin 
SET 
    disponibles = 0,
    updated_at = now()
...
-- Now add constraints to prevent future negative values
...
-- Create the validation trigger function
...
-- Create function to monitor and fix negative committed stock
